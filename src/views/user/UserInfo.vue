		...
		<div class="surface-section">
			...
			<ul class="list-none p-0 m-0">
				<li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
					<div class="text-500 w-6 md:w-2 font-medium">用户ID</div>
			...
			<li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
					<div class="text-500 w-6 md:w-2 font-medium">真实姓名</div>
				...
				<li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
					<div class="text-500 w-6 md:w-2 font-medium">身份证号</div>
					<div class="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{{ idNumber }}</div>
				</li>-->
